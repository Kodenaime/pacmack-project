...
const parentsConference2026: TeamMember[] = [
  ...
  },
  {
    id: 5,
    image: hooper,
    name: 'Saviour Oforiwaa Hooper',
    body: "Saviour Oforiwaa Hooper is a Human Resource Professional, child evangelist, trainer, and ministry leader with a passion for discipling the next generation. She serves on the Global Leadership Team of the 1for50 Global Movement, West Africa, and is Director of the Global Children’s Network and the Director for the Children’s Ministry Department of the Ghana Evangelical Missions Association (GEMA). She is also Logistics Coordinator for Samaritan’s Purse – Operation Christmas Child, Strategic Regional Leadership Team, and Children’s Ministry Facilitator at International Central Gospel Church Horeb Temple. Currently pursuing a Bachelor’s Degree in Theology at South African Theological Seminary, Saviour’s dream is to raise children and young people as Kingdom champions. She is married to Humphrey Hooper and they have two daughters.",
  },
  {
    id: 6,
    image: joana,
